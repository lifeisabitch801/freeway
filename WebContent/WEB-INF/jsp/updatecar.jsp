...
<body>	
	<div class="container">
		...
		<form id="form1" class="form-horizontal" action="${pageContext.request.contextPath}/carinfo/updatecar.action" method="post" >
		<input type="hidden" name="cid" value="${c.cid}">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="" name="ctype" value="${c.ctype}" class="form-control"/>
				</div>					
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="" name="cbackup" value="${c.cbackup}" class="form-control"/>
				</div>					
			</div>
